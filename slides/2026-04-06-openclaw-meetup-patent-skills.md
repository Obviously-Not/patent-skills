...
We kept building things we thought were distinctive — but had no way to know for sure. The traditional path ($500/hour attorneys, weeks of waiting) wasn't realistic for us.
...
|---------|-------|---------|
| Cryptographic Boundary + Unicode Normalization | **12/13** 🔥 | 🟢 Market 🟢 Competitive 🟢 Distinctiveness |
| Static ReDoS Detection (Frame Analysis) | **10/13** | 🟡 Market 🟢 Competitive 🟡 Distinctiveness |
| Separated Command Gate / DM Policy | **9/13** | 🟡 Market 🟢 Competitive 🟡 Distinctiveness |
| Triple-Key Scan Cache | **8/13** | ⚪ Market 🟡 Competitive 🟡 Distinctiveness |
...
A high score flags a pattern worth evaluating for product centrality and defensibility — those determine whether it's worth an attorney's time.

> **Format snapshot:** this deck reflects the April 2026 scanner. The share-card format and scoring vocabulary have since evolved — the current scanner emits **Centrality / Defensibility / Consult?** columns and avoids legal-conclusion terms. See the skill's `SKILL.md` for current output.
...
For too long, IP protection has been a game only well-funded companies could play. The garage inventor, the two-person startup, the solo developer — they create genuinely distinctive work, but can't afford to find out what they have.
